...
class HierBlockGenerator(TopBlockGenerator):
    ...
    def __init__(self, flow_graph, file_path):
        ...
        self.file_path_yaml = self.file_path + '.yaml'

    def write(self):
        """generate output and write it to files"""
        TopBlockGenerator.write(self)

        data = self._build_block_n_from_flow_graph_io()
        with open(self.file_path_yaml, 'w', encoding='utf-8') as yml_file:
            self.dump(data, yml_file)

        try:
            os.chmod(self.file_path_yaml, self._mode)
        except:
            pass

    def dump(self, data, stream):
        # TODO: Copied from the converter. Move to io?
        out = yaml.dump(data)
        replace = [
            ('parameters:', '\nparameters:'),
            ('inputs:', '\ninputs:'),
        ...
        for r in replace:
            out = out.replace(*r)
        prefix = '# auto-generated by grc.companion\n\n'
